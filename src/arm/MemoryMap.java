...
public class MemoryMap extends javax.swing.JFrame {
    ...
    public void updateMap() {
        ...
        newModel.setRowCount(memArray.size());
        for(int i=0; i < memArray.size();i++) {
            ArrayList<String> pairData = memArray.get(i);
            
            int tempMemDir = Integer.parseInt(pairData.get(0));
            
            String memDir = Integer.toHexString(tempMemDir);
            String memData = pairData.get(1);
            
            memDir = memDir.toUpperCase();
            memDir = "0x" + memDir;
            
            memData = memData.toUpperCase();
            memData = "0x" + memData;
            
            newModel.setValueAt(memDir, i, 0);
            newModel.setValueAt(memData, i, 1);
